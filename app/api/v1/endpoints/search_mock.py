# app/api/v1/endpoints/search_mock.py
import asyncio
import logging
...
from app.core.mock_dependencies import (
    get_mock_current_user, check_mock_api_quota, increment_mock_api_usage, get_mock_firestore_db
)
...
async def search_papers(
    ...
    _: bool = Depends(check_mock_api_quota),
    ...
    try:
        ...
        # Increment API usage
        await increment_mock_api_usage(current_user, db, searches=1)
...
async def delete_session(
    ...
    try:
        ...
        # Mark as deleted (in real implementation, this would delete from Firestore)
...
async def process_search_task(
    ...
    try:
        ...
        if search_request.generate_analysis:
            await increment_mock_api_usage(user_id, db, searches=0, papers=len(papers))
